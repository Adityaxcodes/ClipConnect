...
const stats = [
  { title: "Applied Gigs", value: "12", trend: "+2 this month", icon: Users, color: "text-blue-500" },
  { title: "Active Work", value: "5", trend: "In progress", icon: Briefcase, color: "text-amber-500" },
  { title: "Completed", value: "8", trend: "+3 this week", icon: TrendingUp, color: "text-emerald-500" },
  { title: "Success Rate", value: "85%", trend: "Excellent", icon: Clock, color: "text-purple-500" },
]
      ...
      <main className="flex-1 overflow-auto p-3 md:p-6 lg:p-10">
        <div className="mx-auto w-full">
          <div className="mb-6 md:mb-10 flex flex-col justify-between gap-4 md:flex-row md:items-end">
            <div>
              <h1 className="text-2xl md:text-3xl lg:text-4xl font-bold tracking-tight">Clipper Dashboard</h1>
              <p className="mt-1 md:mt-2 text-sm md:text-base text-muted-foreground">
                Find gigs, track your applications, and grow your freelance career.
              </p>
            </div>
            <div className="flex flex-col sm:flex-row gap-2 md:gap-3">
              ...
              >
                <Eye className="mr-2 size-4" /> My Applications
              </Button>
            </div>
          </div>
            ...
            <div className="space-y-6">
              ...
              <Card className="border-white/10 bg-white/5">
                ...
                <div className="divide-y divide-white/10">
                  {[
                    { title: "Application accepted for Video Editor position", time: "2 hours ago", type: "application" },
                    {
                      title: "New gig posted: Motion Graphics Designer",
                      time: "5 hours ago",
                      type: "view",
                    },
                    {
                      title: "Successfully completed 'Content Writer' gig",
                      time: "1 day ago",
                      type: "deadline",
                    },
                  ].map((activity, i) => (
                ...
                <Card className="border-white/10 bg-gradient-to-br from-white/[0.05] to-transparent">
                  <CardContent className="p-6">
                    ...
                    <p className="text-sm leading-relaxed text-muted-foreground">
                      Applications with personalized messages and relevant portfolio links have 3x higher acceptance rates.
                    </p>
                  </CardContent>
                </Card>
                <Card className="border-white/10 bg-gradient-to-br from-white/[0.05] to-transparent">
                  <CardContent className="p-6">
                    ...
                    <p className="text-sm leading-relaxed text-muted-foreground">
                      Apply to gigs within the first 24 hours of posting to increase your chances by 60%.
                    </p>
                  </CardContent>
                </Card>
              </div>
